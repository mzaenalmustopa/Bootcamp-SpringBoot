package com.mzaaenalmustopa.belajarspringconfigproperties.configurationpproperties;

import com.mzaaenalmustopa.belajarspringconfigproperties.converter.StringToDateConverter;
...
public class ConfigurationPropertiesTest {
    ...
    void testDatabaseProperties() {
        Assertions.assertEquals("topa", properties.getDatabase().getUsername());
