package com.mzaaenalmustopa.belajarspringconfigproperties.springbootmessageresource;

import com.mzaaenalmustopa.belajarspringconfigproperties.resourceloader.ResourceLoaderTest;
...
public class SpringBootMessageSourceTest {
    ...
    void testHelloEko() {
        ...
        Assertions.assertEquals("Hallo Eko", sampleSource.helloEko(new Locale("in_ID")));
    }
