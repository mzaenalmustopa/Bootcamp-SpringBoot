...
import mzaaenalmustopa.springwebmvc.model.HelloRequest;
import mzaaenalmustopa.springwebmvc.model.HelloResponse;
...
class BodyControllerTest {
    ...
    void bodyHello() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertEquals("Hello Topa", response.getHello());
        });
    }
}