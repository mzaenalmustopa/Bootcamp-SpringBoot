...
import mzaaenalmustopa.springrestapi.entity.Address;
...
import mzaaenalmustopa.springrestapi.repository.AddressRepository;
...
class AddressControllerTest {
    ...
    void setUp() {
        ...
        contact.setFirstName("zaenal");
        contact.setLastName("mustopa");
        contact.setEmail("zaenal@gmail.com");
        contact.setPhone("0909090909");
    ...
    void getAddressNotFound() throws Exception {
        ...
        mockMvc.perform(
                post("/api/contacts/test/addresses/test")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
    ...
    void listAddressNotFound() throws Exception {
        ...
        mockMvc.perform(
                post("/api/contacts/salah/addresses")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
