...
class ContactControllerTest {
    ...
    void searchUsingName() throws Exception {
        ...
        mockMvc.perform(
                get("/api/contacts")
                        .queryParam("email","zaenal@gmail.com")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
